...
class V1beta1StatefulSetStatus(object):
    ...
    def __init__(self, collision_count=None, current_replicas=None, current_revision=None, observed_generation=None, ready_replicas=None, replicas=None, update_revision=None, updated_replicas=None):  # noqa: E501
