...
class V1beta1SELinuxStrategyOptions(object):
    ...
    def __init__(self, rule=None, se_linux_options=None):  # noqa: E501
        """V1beta1SELinuxStrategyOptions - a model defined in Swagger"""  # noqa: E501
    ...
    def se_linux_options(self):
        ...
        seLinuxOptions required to run as; required for MustRunAs More info: https://git.k8s.io/community/contributors/design-proposals/security_context.md  # noqa: E501
