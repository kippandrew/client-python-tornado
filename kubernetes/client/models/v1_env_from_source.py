...
from kubernetes.client.models.v1_config_map_env_source import V1ConfigMapEnvSource  # noqa: F401,E501
from kubernetes.client.models.v1_secret_env_source import V1SecretEnvSource  # noqa: F401,E501
...
class V1EnvFromSource(object):
    ...
    def prefix(self):
        ...
        An optional identifer to prepend to each key in the ConfigMap. Must be a C_IDENTIFIER.  # noqa: E501
