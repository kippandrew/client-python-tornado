...
from kubernetes.client.models.v1_preconditions import V1Preconditions  # noqa: F401,E501
...
class V1DeleteOptions(object):
    ...
    def propagation_policy(self):
        ...
        Whether and how garbage collection will be performed. Either this field or OrphanDependents may be set, but not both. The default policy is decided by the existing finalizer set in the metadata.finalizers and the resource-specific default policy.  # noqa: E501
