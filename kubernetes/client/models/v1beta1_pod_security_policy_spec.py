...
from kubernetes.client.models.v1beta1_allowed_host_path import V1beta1AllowedHostPath  # noqa: F401,E501
from kubernetes.client.models.v1beta1_fs_group_strategy_options import V1beta1FSGroupStrategyOptions  # noqa: F401,E501
from kubernetes.client.models.v1beta1_host_port_range import V1beta1HostPortRange  # noqa: F401,E501
from kubernetes.client.models.v1beta1_run_as_user_strategy_options import V1beta1RunAsUserStrategyOptions  # noqa: F401,E501
from kubernetes.client.models.v1beta1_se_linux_strategy_options import V1beta1SELinuxStrategyOptions  # noqa: F401,E501
from kubernetes.client.models.v1beta1_supplemental_groups_strategy_options import V1beta1SupplementalGroupsStrategyOptions  # noqa: F401,E501
...
class V1beta1PodSecurityPolicySpec(object):
    ...
    def __init__(self, allow_privilege_escalation=None, allowed_capabilities=None, allowed_host_paths=None, default_add_capabilities=None, default_allow_privilege_escalation=None, fs_group=None, host_ipc=None, host_network=None, host_pid=None, host_ports=None, privileged=None, read_only_root_filesystem=None, required_drop_capabilities=None, run_as_user=None, se_linux=None, supplemental_groups=None, volumes=None):  # noqa: E501
        """V1beta1PodSecurityPolicySpec - a model defined in Swagger"""  # noqa: E501
    ...
    def default_add_capabilities(self):
        ...
        DefaultAddCapabilities is the default set of capabilities that will be added to the container unless the pod spec specifically drops the capability.  You may not list a capabiility in both DefaultAddCapabilities and RequiredDropCapabilities.  # noqa: E501
