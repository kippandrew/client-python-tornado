...
from kubernetes.client.models.v1_affinity import V1Affinity  # noqa: F401,E501
from kubernetes.client.models.v1_container import V1Container  # noqa: F401,E501
from kubernetes.client.models.v1_host_alias import V1HostAlias  # noqa: F401,E501
from kubernetes.client.models.v1_local_object_reference import V1LocalObjectReference  # noqa: F401,E501
from kubernetes.client.models.v1_pod_security_context import V1PodSecurityContext  # noqa: F401,E501
from kubernetes.client.models.v1_toleration import V1Toleration  # noqa: F401,E501
from kubernetes.client.models.v1_volume import V1Volume  # noqa: F401,E501
...
class V1PodSpec(object):
    ...
    def dns_policy(self):
        ...
        Set DNS policy for containers within the pod. One of 'ClusterFirstWithHostNet', 'ClusterFirst' or 'Default'. Defaults to \"ClusterFirst\". To have DNS options set along with hostNetwork, you have to specify DNS policy explicitly to 'ClusterFirstWithHostNet'.  # noqa: E501
    ...
    def priority_class_name(self):
        ...
        If specified, indicates the pod's priority. \"SYSTEM\" is a special keyword which indicates the highest priority. Any other name must be defined by creating a PriorityClass object with that name. If not specified, the pod priority will be default or zero if there is no default.  # noqa: E501
