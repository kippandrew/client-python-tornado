...
class V1ConfigMap(object):
    ...
    def __init__(self, api_version=None, data=None, kind=None, metadata=None):  # noqa: E501
    ...
    def data(self):
        ...
        Data contains the configuration data. Each key must consist of alphanumeric characters, '-', '_' or '.'.  # noqa: E501
