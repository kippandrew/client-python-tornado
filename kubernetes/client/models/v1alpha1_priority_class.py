...
class V1alpha1PriorityClass(object):
    ...
    def global_default(self):
        ...
        globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class.  # noqa: E501
    ...
    def metadata(self):
        ...
        Standard object's metadata. More info: http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata  # noqa: E501
