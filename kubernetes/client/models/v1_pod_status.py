...
from kubernetes.client.models.v1_container_status import V1ContainerStatus  # noqa: F401,E501
from kubernetes.client.models.v1_pod_condition import V1PodCondition  # noqa: F401,E501
...
class V1PodStatus(object):
    ...
    def __init__(self, conditions=None, container_statuses=None, host_ip=None, init_container_statuses=None, message=None, phase=None, pod_ip=None, qos_class=None, reason=None, start_time=None):  # noqa: E501
    ...
    def qos_class(self):
        ...
        The Quality of Service (QOS) classification assigned to the pod based on resource requirements See PodQOSClass type for available QOS classes More info: https://github.com/kubernetes/kubernetes/blob/master/docs/design/resource-qos.md  # noqa: E501
